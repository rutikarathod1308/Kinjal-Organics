...
def update_child_qty_rate(parent_doctype, trans_items, parent_doctype_name, child_docname="items"):
	...
	print("Hello its kinjal organices file code working")
	...
	for d in data:
		...
		if not d.get("docname"):
			...
			prev_warehouse, new_warehouse = child_item.get("warehouse"), d.get("warehouse")
			prev_cost_center, new_cost_center = child_item.get("cost_center"), d.get("cost_center")
			...
			warehouse_unchanged = prev_warehouse == new_warehouse
			cost_center_unchanged = prev_cost_center == new_cost_center
			...
			if (
				...
				and uom_unchanged
				and date_unchanged
				and warehouse_unchanged
				and cost_center_unchanged
			):
				continue
		
		if d.get("warehouse") and parent_doctype == "Purchase Order":
			child_item.warehouse = d.get("warehouse")
		
		if d.get("cost_center") and parent_doctype == "Purchase Order":
